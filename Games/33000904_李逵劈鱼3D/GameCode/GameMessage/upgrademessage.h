...
#define SKIN_FOLDER						TEXT("33000904")			//图片文件夹
...
/*------------------------------------------------------------------------------*/
#define DEF_SCREEN_WIDTH	  1434		// 默认屏宽
#define DEF_SCREEN_HEIGHT	  872			// 默认屏高
...
struct tagPM
{
	int iPlayingMethod;		//游戏玩法（PM_FLAGS）
 	BYTE byGameTime;		//游戏时间（分钟）
};
...
enum PM_FLAGS
{
	...
	FourFight = 1 << 3,			//四人对战
	OneRatioOne = 1 << 4,		//结算1:1
	OneRatioTen = 1 << 5,		//结算1:10
};
